...
<script>
  ...
  import PatternElementComponent from '../../../../components/PatternElementComponent';
  import PatternElementSettingsComponent from '../../../../components/PatternElementSettingsComponent';
